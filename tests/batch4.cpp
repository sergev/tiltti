...
TEST_F(MachineTest, div_al_batch4)
{
    ...
    EXPECT_EQ(memory.load8(0x008F5), 0x86);
    EXPECT_EQ(memory.load8(0x008F6), 0xF0);
...
TEST_F(MachineTest, div_ax_batch4)
{
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0x9502E), 0x96);
    EXPECT_EQ(memory.load8(0x9502F), 0xF0);
...
TEST_F(MachineTest, div_byte_ss_bp_di_7h_batch4)
{
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0xB2F61), 0x12);
    EXPECT_EQ(memory.load8(0xB2F62), 0xF8);
...
TEST_F(MachineTest, idiv_byte_ds_bx_di_batch4)
{
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0x822F8), 0x02);
    EXPECT_EQ(memory.load8(0x822F9), 0xFC);
...
TEST_F(MachineTest, idiv_byte_ds_di_batch4)
{
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0x9F160), 0x06);
    EXPECT_EQ(memory.load8(0x9F161), 0xF4);
...
TEST_F(MachineTest, idiv_dh_batch4)
{
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0xD5143), 0x06);
    EXPECT_EQ(memory.load8(0xD5144), 0xF4);
...
TEST_F(MachineTest, idiv_word_ss_bp_si_16h_batch4)
{
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0x3DAF7), 0x12);
    EXPECT_EQ(memory.load8(0x3DAF8), 0xF0);
