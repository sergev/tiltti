...
// mul byte [cs:bx+di]
//
TEST_F(Test8086, mul_byte_cs_bx_di)
{
    // Initial CPU State
    cpu.set_ax(0x2F75);
    cpu.set_bx(0xCDB4);
...
//
TEST_F(Test8086, mul_byte_es_bx_di_67C4h)
{
    // Initial CPU State
    cpu.set_ax(0x3715);
    cpu.set_bx(0x5297);
...
//
TEST_F(Test8086, mul_word_ds_bx_di_5C06h)
{
    // Initial CPU State
    cpu.set_ax(0xCDBD);
    cpu.set_bx(0xD399);
...
// mul word [ds:bx+si]
//
TEST_F(Test8086, mul_word_ds_bx_si)
{
    // Initial CPU State
    cpu.set_ax(0x4F3A);
    cpu.set_bx(0xD486);
...
//
TEST_F(Test8086, imul_byte_es_bx_di_21h)
{
    // Initial CPU State
    cpu.set_ax(0x2B44);
    cpu.set_bx(0x247C);
...
//
TEST_F(Test8086, imul_word_ds_bx_di_6Fh)
{
    // Initial CPU State
    cpu.set_ax(0x6D0D);
    cpu.set_bx(0xF3F1);
