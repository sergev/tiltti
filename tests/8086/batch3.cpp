...
// imul ah
//
TEST_F(Test8086, imul_ah_batch3)
{
    // Initial CPU State
    cpu.set_ax(0xEF33);
    cpu.set_bx(0x0000);
...
//
TEST_F(Test8086, imul_byte_ss_bp_si_51h_batch3)
{
    // Initial CPU State
    cpu.set_ax(0xA6F3);
    cpu.set_bx(0x3163);
...
// imul word [cs:bp+4Ah]
//
TEST_F(Test8086, imul_word_cs_bp_4Ah_batch3)
{
    // Initial CPU State
    cpu.set_ax(0x0876);
    cpu.set_bx(0x1508);
...
// imul word [ds:di]
//
TEST_F(Test8086, imul_word_ds_di_batch3)
{
    // Initial CPU State
    cpu.set_ax(0xCE14);
    cpu.set_bx(0xBBF1);
...
//
TEST_F(Test8086, mul_byte_es_bx_di_33h_batch3)
{
    // Initial CPU State
    cpu.set_ax(0x9EC7);
    cpu.set_bx(0xF4BE);
...
//
TEST_F(Test8086, rcl_byte_ss_bx_di_526Dh_cl_batch3)
{
    // Initial CPU State
    cpu.set_ax(0x646C);
    cpu.set_bx(0xA7C9);
