...
TEST_F(Test8086, cs_repne_cmpsb)
{
    // Initial CPU State
    cpu.set_ax(0x03C7);
    cpu.set_bx(0xB910);
...
TEST_F(Test8086, cs_repne_scasw)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x4286);
