...
// aad F8h
//
TEST_F(Test8086, aad_F8h_batch17)
{
    // Initial CPU State
    cpu.set_ax(0xC681);
    cpu.set_bx(0x430A);
...
// aam F8h
//
TEST_F(Test8086, aam_F8h_batch17)
{
    // Initial CPU State
    cpu.set_ax(0x957D);
    cpu.set_bx(0x09BA);
...
// div al
//
TEST_F(Test8086, div_al_batch17)
{
    // Initial CPU State
    cpu.set_ax(0x246D);
    cpu.set_bx(0x5C13);
...
// div byte [cs:B537h]
//
TEST_F(Test8086, div_byte_cs_B537h_batch17)
{
    // Initial CPU State
    cpu.set_ax(0x3EB6);
    cpu.set_bx(0x0000);
...
// idiv al
//
TEST_F(Test8086, idiv_al_batch17)
{
    // Initial CPU State
    cpu.set_ax(0x134E);
    cpu.set_bx(0xE2C1);
...
// idiv byte [cs:bp+di]
//
TEST_F(Test8086, idiv_byte_cs_bp_di_batch17)
{
    // Initial CPU State
    cpu.set_ax(0xF2E3);
    cpu.set_bx(0xEC9D);
...
// imul ah
//
TEST_F(Test8086, imul_ah_batch17)
{
    // Initial CPU State
    cpu.set_ax(0xAFA9);
    cpu.set_bx(0xDCC0);
...
// imul byte [cs:8BBDh]
//
TEST_F(Test8086, imul_byte_cs_8BBDh_batch17)
{
    // Initial CPU State
    cpu.set_ax(0x2ECC);
    cpu.set_bx(0x92CE);
...
// mul ax
//
TEST_F(Test8086, mul_ax_batch17)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x348D);
