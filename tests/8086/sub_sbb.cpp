...
TEST_F(Test8086, sbb_bl_byte_ds_bx_si_63h)
{
    // Initial CPU State
    cpu.set_ax(0x5581);
    cpu.set_bx(0x69C1);
...
TEST_F(Test8086, sbb_byte_ds_bp_di_5123h_dh)
{
    // Initial CPU State
    cpu.set_ax(0x61FF);
    cpu.set_bx(0x0B5C);
...
TEST_F(Test8086, sbb_byte_es_si_3AE9h_9Ch)
{
    // Initial CPU State
    cpu.set_ax(0x6AF1);
    cpu.set_bx(0x8A14);
...
TEST_F(Test8086, sbb_byte_ss_bx_di_5h_2Dh)
{
    // Initial CPU State
    cpu.set_ax(0x5388);
    cpu.set_bx(0x55D4);
...
TEST_F(Test8086, sbb_si_word_ss_si_796Bh)
{
    // Initial CPU State
    cpu.set_ax(0x97AE);
    cpu.set_bx(0xA5D3);
...
TEST_F(Test8086, sbb_word_ds_di_Eh)
{
    // Initial CPU State
    cpu.set_ax(0x9CAD);
    cpu.set_bx(0xB1C4);
...
TEST_F(Test8086, sbb_word_ds_di_sp)
{
    // Initial CPU State
    cpu.set_ax(0x99CC);
    cpu.set_bx(0xC317);
...
TEST_F(Test8086, sub_bx_word_ds_bx_di_1263h)
{
    // Initial CPU State
    cpu.set_ax(0x74B8);
    cpu.set_bx(0x9509);
...
TEST_F(Test8086, sub_byte_ds_bx_si_61h_4h)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, sub_byte_es_bp_di_6Ah)
{
    // Initial CPU State
    cpu.set_ax(0x8E62);
    cpu.set_bx(0x1C5D);
...
TEST_F(Test8086, sub_ch_byte_ds_si_28h)
{
    // Initial CPU State
    cpu.set_ax(0x0946);
    cpu.set_bx(0x2663);
...
TEST_F(Test8086, sub_word_ds_di_77EEh_ax)
{
    // Initial CPU State
    cpu.set_ax(0x4FE9);
    cpu.set_bx(0x8CAD);
...
TEST_F(Test8086, sub_word_ss_si_3h_8F8Ah)
{
    // Initial CPU State
    cpu.set_ax(0xC7A5);
    cpu.set_bx(0x3FBF);
