...
TEST_F(Test8086, esc_word_cs_bx_di_44h)
{
    // Initial CPU State
    cpu.set_ax(0x50F6);
    cpu.set_bx(0x6565);
...
TEST_F(Test8086, esc_word_ds_bx_di_3h)
{
    // Initial CPU State
    cpu.set_ax(0x3A6D);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, esc_word_ds_di)
{
    // Initial CPU State
    cpu.set_ax(0x34F9);
    cpu.set_bx(0x175C);
...
TEST_F(Test8086, esc_word_ds_si)
{
    // Initial CPU State
    cpu.set_ax(0x975C);
    cpu.set_bx(0x843D);
...
TEST_F(Test8086, esc_word_es_bp_22C0h)
{
    // Initial CPU State
    cpu.set_ax(0x7EDE);
    cpu.set_bx(0x407A);
...
TEST_F(Test8086, esc_word_es_bp_F08h)
{
    // Initial CPU State
    cpu.set_ax(0xC25C);
    cpu.set_bx(0x666F);
...
TEST_F(Test8086, esc_word_es_bx_di_23h)
{
    // Initial CPU State
    cpu.set_ax(0xDB8C);
    cpu.set_bx(0x22C2);
...
TEST_F(Test8086, esc_word_ss_bp_si)
{
    // Initial CPU State
    cpu.set_ax(0x064E);
    cpu.set_bx(0xA24F);
