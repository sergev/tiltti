...
TEST_F(Test8086, lds_sp_dword_ss_bx_si_3E2Ch)
{
    // Initial CPU State
    cpu.set_ax(0xCB3A);
    cpu.set_bx(0x1972);
...
TEST_F(Test8086, lea_sp_es_bp_si_75h)
{
    // Initial CPU State
    cpu.set_ax(0x0AA1);
    cpu.set_bx(0xFE6B);
...
TEST_F(Test8086, les_bx_dword_cs_bx_si_3Bh)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x1247);
...
TEST_F(Test8086, xchg_di_word_ss_bp_si_31F6h)
{
    // Initial CPU State
    cpu.set_ax(0xB4B0);
    cpu.set_bx(0x696C);
