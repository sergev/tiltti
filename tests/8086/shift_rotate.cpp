...
TEST_F(Test8086, rcl_byte_ds_si_33h)
{
    // Initial CPU State
    cpu.set_ax(0x1EE3);
    cpu.set_bx(0x6DDE);
...
TEST_F(Test8086, rcl_byte_ss_bp_30h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xC90D);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, rcl_word_ds_bx_39CEh)
{
    // Initial CPU State
    cpu.set_ax(0x41A6);
    cpu.set_bx(0x9D92);
...
TEST_F(Test8086, rcl_word_ds_bx_di_cl)
{
    // Initial CPU State
    cpu.set_ax(0x3157);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, rcr_byte_ds_bx_1405h)
{
    // Initial CPU State
    cpu.set_ax(0x25A7);
    cpu.set_bx(0xEA01);
...
TEST_F(Test8086, rcr_byte_ds_si_5h_cl)
{
    // Initial CPU State
    cpu.set_ax(0x1954);
    cpu.set_bx(0x8ED1);
...
TEST_F(Test8086, rcr_word_ss_bp_5813h_cl)
{
    // Initial CPU State
    cpu.set_ax(0x6F9D);
    cpu.set_bx(0x4863);
...
TEST_F(Test8086, rcr_word_ss_di)
{
    // Initial CPU State
    cpu.set_ax(0x0411);
    cpu.set_bx(0xB682);
...
TEST_F(Test8086, rol_byte_ds_bp_di_7595h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xEFB2);
    cpu.set_bx(0x821D);
...
TEST_F(Test8086, rol_byte_ss_bp_si)
{
    // Initial CPU State
    cpu.set_ax(0xC203);
    cpu.set_bx(0x3808);
...
TEST_F(Test8086, rol_word_ds_bx_si_14h)
{
    // Initial CPU State
    cpu.set_ax(0xFFEB);
    cpu.set_bx(0x46D0);
...
TEST_F(Test8086, ror_byte_cs_si_76h)
{
    // Initial CPU State
    cpu.set_ax(0xFEF0);
    cpu.set_bx(0x377B);
...
TEST_F(Test8086, ror_byte_ds_bx_si_45F3h_cl)
{
    // Initial CPU State
    cpu.set_ax(0x5D07);
    cpu.set_bx(0x1351);
...
TEST_F(Test8086, ror_word_es_bp_di_cl)
{
    // Initial CPU State
    cpu.set_ax(0xC06A);
    cpu.set_bx(0x49CE);
...
TEST_F(Test8086, sar_byte_ds_bx_80h)
{
    // Initial CPU State
    cpu.set_ax(0x24FC);
    cpu.set_bx(0x1048);
...
TEST_F(Test8086, sar_byte_ds_si_75h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xC540);
    cpu.set_bx(0x1A8E);
...
TEST_F(Test8086, sar_word_ds_bx_si_18h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xF3DC);
    cpu.set_bx(0xDAAD);
...
TEST_F(Test8086, setmo_byte_ds_bx)
{
    // Initial CPU State
    cpu.set_ax(0xCD98);
    cpu.set_bx(0x4714);
...
TEST_F(Test8086, shl_byte_ds_bx_3C8Dh_cl)
{
    // Initial CPU State
    cpu.set_ax(0x1832);
    cpu.set_bx(0x79CA);
...
TEST_F(Test8086, shl_byte_ss_bx_di_39h)
{
    // Initial CPU State
    cpu.set_ax(0x162D);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, shl_word_ds_bx_di_cl)
{
    // Initial CPU State
    cpu.set_ax(0x6446);
    cpu.set_bx(0xB8DE);
...
TEST_F(Test8086, shl_word_ss_bp_3Ch)
{
    // Initial CPU State
    cpu.set_ax(0x7EEA);
    cpu.set_bx(0xCAE6);
...
TEST_F(Test8086, shr_byte_ss_4C72h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xF760);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, shr_word_ds_si_cl)
{
    // Initial CPU State
    cpu.set_ax(0x0294);
    cpu.set_bx(0xFA06);
...
TEST_F(Test8086, shr_word_ss_bp_si_3D28h)
{
    // Initial CPU State
    cpu.set_ax(0x85F7);
    cpu.set_bx(0x427F);
