...
TEST_F(Test8086, adc_byte_ds_bp_di_2h_F8h)
{
    // Initial CPU State
    cpu.set_ax(0xAB64);
    cpu.set_bx(0xCCA7);
...
TEST_F(Test8086, adc_byte_ds_bx_di_BEBh_bl)
{
    // Initial CPU State
    cpu.set_ax(0x8849);
    cpu.set_bx(0x67DB);
...
TEST_F(Test8086, adc_byte_ss_bp_4Ch_50h)
{
    // Initial CPU State
    cpu.set_ax(0x0E1F);
    cpu.set_bx(0xEE2D);
...
TEST_F(Test8086, adc_di_word_ds_bp_di_7Fh)
{
    // Initial CPU State
    cpu.set_ax(0x077C);
    cpu.set_bx(0x3CA9);
...
TEST_F(Test8086, adc_word_cs_bx_si_Ch_134Bh)
{
    // Initial CPU State
    cpu.set_ax(0xFF71);
    cpu.set_bx(0x2BE0);
...
TEST_F(Test8086, adc_word_ss_bp_si_17h)
{
    // Initial CPU State
    cpu.set_ax(0xD05A);
    cpu.set_bx(0xE44F);
...
TEST_F(Test8086, adc_word_ss_si_5119h_cx)
{
    // Initial CPU State
    cpu.set_ax(0x2C79);
    cpu.set_bx(0x2D77);
...
TEST_F(Test8086, add_byte_es_bp_di_1F2Ch_70h)
{
    // Initial CPU State
    cpu.set_ax(0xBC52);
    cpu.set_bx(0x0573);
...
TEST_F(Test8086, add_byte_es_si_3AE9h_9Ch)
{
    // Initial CPU State
    cpu.set_ax(0x6AF1);
    cpu.set_bx(0x8A14);
...
TEST_F(Test8086, add_word_ds_bx_si_DE2h_92E7h)
{
    // Initial CPU State
    cpu.set_ax(0xE997);
    cpu.set_bx(0x2292);
...
TEST_F(Test8086, add_word_ds_si_25h_dx)
{
    // Initial CPU State
    cpu.set_ax(0xF65A);
    cpu.set_bx(0xC4E2);
...
TEST_F(Test8086, add_word_ss_bx_di_1Eh_FFEDh)
{
    // Initial CPU State
    cpu.set_ax(0x6C31);
    cpu.set_bx(0x47D7);
