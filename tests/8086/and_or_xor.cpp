...
TEST_F(Test8086, and_byte_ds_bp_di_41E5h_6Ah)
{
    // Initial CPU State
    cpu.set_ax(0xE295);
    cpu.set_bx(0x8432);
...
TEST_F(Test8086, and_byte_ss_bp_65h_90h)
{
    // Initial CPU State
    cpu.set_ax(0xAF67);
    cpu.set_bx(0x5072);
...
TEST_F(Test8086, and_word_cs_bx_si_FFA4h)
{
    // Initial CPU State
    cpu.set_ax(0x0464);
    cpu.set_bx(0x002A);
...
TEST_F(Test8086, and_word_ds_bx_si_634Ah)
{
    // Initial CPU State
    cpu.set_ax(0x7C8D);
    cpu.set_bx(0x5EF4);
...
TEST_F(Test8086, and_word_ss_di_41h_di)
{
    // Initial CPU State
    cpu.set_ax(0x9B62);
    cpu.set_bx(0xED5B);
...
TEST_F(Test8086, or_bh_byte_cs_bp_78h)
{
    // Initial CPU State
    cpu.set_ax(0x3C00);
    cpu.set_bx(0xF821);
...
TEST_F(Test8086, or_byte_ds_bx_di_31B5h_Ah)
{
    // Initial CPU State
    cpu.set_ax(0xD430);
    cpu.set_bx(0x05AE);
...
TEST_F(Test8086, or_byte_ss_bp_65h_90h)
{
    // Initial CPU State
    cpu.set_ax(0xAF67);
    cpu.set_bx(0x5072);
...
TEST_F(Test8086, or_di_word_ds_si)
{
    // Initial CPU State
    cpu.set_ax(0xFA8D);
    cpu.set_bx(0xDE12);
...
TEST_F(Test8086, or_word_ds_bx_si_47C4h_4h)
{
    // Initial CPU State
    cpu.set_ax(0x2982);
    cpu.set_bx(0x0CEC);
...
TEST_F(Test8086, or_word_ss_bp_si_629Ch_5531h)
{
    // Initial CPU State
    cpu.set_ax(0xE43E);
    cpu.set_bx(0x2DF6);
...
TEST_F(Test8086, xor_byte_ss_bp_si_Fh_bh)
{
    // Initial CPU State
    cpu.set_ax(0x624C);
    cpu.set_bx(0xA6B7);
...
TEST_F(Test8086, xor_dl_byte_ss_bp_si_1h)
{
    // Initial CPU State
    cpu.set_ax(0x9C47);
    cpu.set_bx(0xD94C);
...
TEST_F(Test8086, xor_word_ds_bx_di_63h_bp)
{
    // Initial CPU State
    cpu.set_ax(0xCE14);
    cpu.set_bx(0xCB19);
...
TEST_F(Test8086, xor_word_ds_si_6C5Eh_7645h)
{
    // Initial CPU State
    cpu.set_ax(0x5270);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, xor_word_ss_bp_F0Eh_FFD8h)
{
    // Initial CPU State
    cpu.set_ax(0xDCAF);
    cpu.set_bx(0x2CAE);
