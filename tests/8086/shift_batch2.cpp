...
//
TEST_F(Test8086, rcl_byte_ss_bp_si_0h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xB53E);
    cpu.set_bx(0xE0C7);
...
//
TEST_F(Test8086, rcr_byte_cs_bx_32A8h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xC182);
    cpu.set_bx(0x19F8);
...
//
TEST_F(Test8086, rol_byte_ss_bp_di_cl)
{
    // Initial CPU State
    cpu.set_ax(0xB52A);
    cpu.set_bx(0xCB73);
...
// rol si, cl
//
TEST_F(Test8086, rol_si_cl_batch2)
{
    // Initial CPU State
    cpu.set_ax(0x780F);
    cpu.set_bx(0x429B);
...
//
TEST_F(Test8086, rol_word_ss_bp_41h_cl)
{
    // Initial CPU State
    cpu.set_ax(0x8332);
    cpu.set_bx(0x65EF);
...
//
TEST_F(Test8086, ror_word_ds_bx_di_2FC1h_cl)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x1EBD);
...
//
TEST_F(Test8086, sar_byte_ss_bp_7486h_cl)
{
    // Initial CPU State
    cpu.set_ax(0x46BE);
    cpu.set_bx(0xA99C);
...
// shl byte [ds:bx+di]
//
TEST_F(Test8086, shl_byte_ds_bx_di)
{
    // Initial CPU State
    cpu.set_ax(0xEFDD);
    cpu.set_bx(0x1EB2);
...
// shl word [ds:di-6h]
//
TEST_F(Test8086, shl_word_ds_di_6h)
{
    // Initial CPU State
    cpu.set_ax(0xA4EE);
    cpu.set_bx(0xCB12);
...
//
TEST_F(Test8086, shl_word_ss_bx_5Ch_cl)
{
    // Initial CPU State
    cpu.set_ax(0xAE09);
    cpu.set_bx(0x7EFC);
...
//
TEST_F(Test8086, shr_byte_ss_bp_di_6Eh_cl)
{
    // Initial CPU State
    cpu.set_ax(0x23A2);
    cpu.set_bx(0xFC05);
...
//
TEST_F(Test8086, shr_word_ds_bx_3BF8h_cl)
{
    // Initial CPU State
    cpu.set_ax(0xACD4);
    cpu.set_bx(0x030B);
...
//
TEST_F(Test8086, shr_word_es_bp_si_cl)
{
    // Initial CPU State
    cpu.set_ax(0xE993);
    cpu.set_bx(0x2DE5);
...
//
TEST_F(Test8086, shr_word_ss_bp_si_6Dh_cl)
{
    // Initial CPU State
    cpu.set_ax(0xDEA2);
    cpu.set_bx(0xB038);
