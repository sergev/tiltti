...
// div byte [ds:bx+5Ch]
//
TEST_F(Test8086, div_byte_ds_bx_5Ch)
{
    // Initial CPU State
    cpu.set_ax(0x702E);
    cpu.set_bx(0xD343);
...
//
TEST_F(Test8086, div_byte_es_bx_di_6188h)
{
    // Initial CPU State
    cpu.set_ax(0xAFD4);
    cpu.set_bx(0x849C);
    ...
    EXPECT_EQ(memory.load8(0x11D17), 0x02 & ~cpu.u_flags());
    EXPECT_EQ(memory.load8(0x11D18), 0xF8 & ~(cpu.u_flags() >> 8));
...
// div byte [es:si-5Ch]
//
TEST_F(Test8086, div_byte_es_si_5Ch)
{
    // Initial CPU State
    cpu.set_ax(0x8369);
    cpu.set_bx(0x89E6);
...
// div word [cs:bx+46h]
//
TEST_F(Test8086, div_word_cs_bx_46h)
{
    // Initial CPU State
    cpu.set_ax(0xB236);
    cpu.set_bx(0xCBA0);
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0x7E40F), 0x92 & ~cpu.u_flags());
    EXPECT_EQ(memory.load8(0x7E410), 0xF4 & ~(cpu.u_flags() >> 8));
...
// div word [ss:bp+di]
//
TEST_F(Test8086, div_word_ss_bp_di)
{
    // Initial CPU State
    cpu.set_ax(0xE575);
    cpu.set_bx(0x3175);
    ...
    EXPECT_EQ(memory.load8(0x00002), 0x00);
    EXPECT_EQ(memory.load8(0x00003), 0x00);
    EXPECT_EQ(memory.load8(0x4AAFE), 0x06 & ~cpu.u_flags());
    EXPECT_EQ(memory.load8(0x4AAFF), 0xF4 & ~(cpu.u_flags() >> 8));
...
//
TEST_F(Test8086, div_word_ss_bp_si_18C6h)
{
    // Initial CPU State
    cpu.set_ax(0x249C);
    cpu.set_bx(0x0141);
...
// idiv byte [ds:AD0Eh]
//
TEST_F(Test8086, idiv_byte_ds_AD0Eh)
{
    // Initial CPU State
    cpu.set_ax(0x73F4);
    cpu.set_bx(0xC55E);
...
//
TEST_F(Test8086, idiv_byte_ss_bx_di_510Ah)
{
    // Initial CPU State
    cpu.set_ax(0x3CE0);
    cpu.set_bx(0x3C8B);
...
//
TEST_F(Test8086, idiv_word_cs_bp_di_28CEh)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x7060);
...
//
TEST_F(Test8086, idiv_word_ds_si_3E03h)
{
    // Initial CPU State
    cpu.set_ax(0x569F);
    cpu.set_bx(0x5D79);
...
//
TEST_F(Test8086, idiv_word_es_si_5522h)
{
    // Initial CPU State
    cpu.set_ax(0xC52A);
    cpu.set_bx(0x5C32);
