...
TEST_F(Test8086, div_byte_ds_bx)
{
    // Initial CPU State
    cpu.set_ax(0x16B1);
    cpu.set_bx(0x4144);
...
TEST_F(Test8086, div_word_ds_si_39h)
{
    // Initial CPU State
    cpu.set_ax(0x1DAE);
    cpu.set_bx(0x229F);
...
TEST_F(Test8086, idiv_byte_ds_bx_si_5AD8h)
{
    // Initial CPU State
    cpu.set_ax(0x7E46);
    cpu.set_bx(0x2E0F);
...
TEST_F(Test8086, idiv_word_ss_bp_di)
{
    // Initial CPU State
    cpu.set_ax(0xCB93);
    cpu.set_bx(0xE9F9);
...
TEST_F(Test8086, imul_byte_es_bp_si_2Eh)
{
    // Initial CPU State
    cpu.set_ax(0x4F34);
    cpu.set_bx(0xA9AB);
...
TEST_F(Test8086, imul_word_cs_si)
{
    // Initial CPU State
    cpu.set_ax(0xE4CD);
    cpu.set_bx(0x1536);
...
TEST_F(Test8086, mul_byte_ss_bp_di_79h)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x6350);
...
TEST_F(Test8086, mul_word_es_bp_di_75h)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0xDD89);
...
TEST_F(Test8086, neg_word_ds_si_3h)
{
    // Initial CPU State
    cpu.set_ax(0x276E);
    cpu.set_bx(0x439E);
...
TEST_F(Test8086, not_byte_ds_bx_di_26h)
{
    // Initial CPU State
    cpu.set_ax(0x8B8D);
    cpu.set_bx(0xBCDC);
...
TEST_F(Test8086, not_word_ss_bp_Eh)
{
    // Initial CPU State
    cpu.set_ax(0x356C);
    cpu.set_bx(0xBA6E);
