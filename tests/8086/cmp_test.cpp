...
TEST_F(Test8086, cmp_byte_ss_bp_di_664h_ch)
{
    // Initial CPU State
    cpu.set_ax(0x6A3E);
    cpu.set_bx(0x0B7C);
...
TEST_F(Test8086, cmp_byte_ss_bp_si_1FF1h_46h)
{
    // Initial CPU State
    cpu.set_ax(0xF77B);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, cmp_byte_ss_bp_si_3Bh)
{
    // Initial CPU State
    cpu.set_ax(0x51D4);
    cpu.set_bx(0x91AB);
...
TEST_F(Test8086, cmp_ch_byte_cs_bp_79h)
{
    // Initial CPU State
    cpu.set_ax(0x9251);
    cpu.set_bx(0xFCCF);
...
TEST_F(Test8086, cmp_dx_word_ss_bp_di_74EFh)
{
    // Initial CPU State
    cpu.set_ax(0xD709);
    cpu.set_bx(0xE67E);
...
TEST_F(Test8086, cmp_word_ss_BC2h_FFF4h)
{
    // Initial CPU State
    cpu.set_ax(0xC65C);
    cpu.set_bx(0xB985);
...
TEST_F(Test8086, cmp_word_ss_bp_4Ch_4050h)
{
    // Initial CPU State
    cpu.set_ax(0x0E1F);
    cpu.set_bx(0xEE2D);
...
TEST_F(Test8086, test_byte_ss_bp_di_663Bh_al)
{
    // Initial CPU State
    cpu.set_ax(0x7EC9);
    cpu.set_bx(0x5311);
...
TEST_F(Test8086, test_byte_ss_bp_di_9h)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x10E4);
...
TEST_F(Test8086, test_byte_ss_si_3055h_DFh)
{
    // Initial CPU State
    cpu.set_ax(0xEEF4);
    cpu.set_bx(0xEB16);
...
TEST_F(Test8086, test_word_ds_B835h_bx)
{
    // Initial CPU State
    cpu.set_ax(0xC43F);
    cpu.set_bx(0xC909);
...
TEST_F(Test8086, test_word_ds_bp_67h_91B9h)
{
    // Initial CPU State
    cpu.set_ax(0xD5FD);
    cpu.set_bx(0x5F8F);
...
TEST_F(Test8086, test_word_ss_bp_si_DFB1h)
{
    // Initial CPU State
    cpu.set_ax(0xF3A0);
    cpu.set_bx(0xFB0C);
