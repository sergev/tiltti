...
TEST_F(Test8086, call_word_ss_bp_65h)
{
    // Initial CPU State
    cpu.set_ax(0xAF67);
    cpu.set_bx(0x5072);
...
TEST_F(Test8086, callf_3558h_7C02h)
{
    // Initial CPU State
    cpu.set_ax(0xD550);
    cpu.set_bx(0xA9C5);
...
TEST_F(Test8086, callf_word_ss_bp_4Ch)
{
    // Initial CPU State
    cpu.set_ax(0x0E1F);
    cpu.set_bx(0xEE2D);
...
TEST_F(Test8086, jmp_word_ds_bx_si_50EFh)
{
    // Initial CPU State
    cpu.set_ax(0x119D);
    cpu.set_bx(0x839F);
...
TEST_F(Test8086, jmpf_819Bh_257Eh)
{
    // Initial CPU State
    cpu.set_ax(0xA0AF);
    cpu.set_bx(0xFA5B);
...
TEST_F(Test8086, jmpf_word_cs_si)
{
    // Initial CPU State
    cpu.set_ax(0x1B5B);
    cpu.set_bx(0xCBDB);
