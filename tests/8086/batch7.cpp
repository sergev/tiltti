...
// call word [ds:di-1h]
//
TEST_F(Test8086, call_word_ds_di_1h_batch7)
{
    // Initial CPU State
    cpu.set_ax(0xD840);
    cpu.set_bx(0x9429);
...
//
TEST_F(Test8086, idiv_byte_ss_bp_1FFEh_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x3354);
    cpu.set_bx(0x26D2);
...
// idiv ch
//
TEST_F(Test8086, idiv_ch_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x3D4D);
    cpu.set_bx(0xEC40);
...
//
TEST_F(Test8086, mov_ax_word_ds_AF24h_batch7)
{
    // Initial CPU State
    cpu.set_ax(0xB885);
    cpu.set_bx(0x5845);
...
//
TEST_F(Test8086, mov_ax_word_es_FFFFh_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x53C5);
    cpu.set_bx(0x9102);
...
// rcr ah, cl
//
TEST_F(Test8086, rcr_ah_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0xFD83);
    cpu.set_bx(0x6928);
...
// rcr bx, cl
//
TEST_F(Test8086, rcr_bx_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0xBD8B);
    cpu.set_bx(0x78A5);
...
//
TEST_F(Test8086, rcr_byte_cs_bp_di_3865h_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0xF075);
    cpu.set_bx(0xCA4D);
...
//
TEST_F(Test8086, rcr_byte_ds_bp_6Fh_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x9A03);
    cpu.set_bx(0xF66C);
...
//
TEST_F(Test8086, rcr_byte_es_bx_si_630Fh_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0xBDAC);
    cpu.set_bx(0x9613);
...
//
TEST_F(Test8086, rcr_byte_ss_si_66h_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x7C77);
    cpu.set_bx(0x43E7);
...
// rcr cl, cl
//
TEST_F(Test8086, rcr_cl_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x49EE);
    cpu.set_bx(0x75B4);
...
// rcr sp, cl
//
TEST_F(Test8086, rcr_sp_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0xFF55);
    cpu.set_bx(0xEFF7);
...
//
TEST_F(Test8086, rcr_word_cs_bp_9h_cl_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x961D);
    cpu.set_bx(0xADFA);
...
// retn 97EDh
//
TEST_F(Test8086, retn_97EDh_batch7)
{
    // Initial CPU State
    cpu.set_ax(0x61FB);
    cpu.set_bx(0x9C12);
