...
// idiv byte [es:bp+7Eh]
//
TEST_F(Test8086, idiv_byte_es_bp_7Eh_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x0B9F);
    cpu.set_bx(0x0FF2);
...
// imul al
//
TEST_F(Test8086, imul_al_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x9905);
    cpu.set_bx(0xBF57);
...
// imul byte [ds:bx+di]
//
TEST_F(Test8086, imul_byte_ds_bx_di_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x88ED);
    cpu.set_bx(0x39CD);
...
//
TEST_F(Test8086, imul_byte_ss_bp_di_35h_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x53ED);
    cpu.set_bx(0xFE28);
...
// imul word [cs:bx+1Ah]
//
TEST_F(Test8086, imul_word_cs_bx_1Ah_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xEE9C);
    cpu.set_bx(0xE45B);
...
//
TEST_F(Test8086, imul_word_cs_bx_di_4Dh_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x03DC);
    cpu.set_bx(0x1062);
...
// rcl bp, cl
//
TEST_F(Test8086, rcl_bp_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xB1BD);
    cpu.set_bx(0x0000);
...
//
TEST_F(Test8086, rcl_word_es_bp_di_55h_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x61E8);
    cpu.set_bx(0xEA3E);
...
// rcr al, cl
//
TEST_F(Test8086, rcr_al_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xB6B7);
    cpu.set_bx(0xE236);
...
//
TEST_F(Test8086, rcr_byte_es_bx_57h_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xD908);
    cpu.set_bx(0x01B9);
...
//
TEST_F(Test8086, rcr_byte_ss_bp_si_Dh_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x0DB7);
    cpu.set_bx(0x851A);
...
//
TEST_F(Test8086, setmoc_byte_ss_bp_di_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xECD3);
    cpu.set_bx(0xA319);
...
//
TEST_F(Test8086, setmoc_word_cs_si_7CCDh_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x151A);
    cpu.set_bx(0xDC23);
...
//
TEST_F(Test8086, setmoc_word_ds_bp_1110h_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x1C1D);
    cpu.set_bx(0x0000);
...
//
TEST_F(Test8086, setmoc_word_ds_bp_di_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x31E5);
    cpu.set_bx(0x6736);
...
//
TEST_F(Test8086, setmoc_word_ss_bx_si_7Ch_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x568F);
    cpu.set_bx(0xCAB8);
...
//
TEST_F(Test8086, shl_byte_ss_bp_34Fh_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x8377);
    cpu.set_bx(0x80CC);
...
// shl dh, cl
//
TEST_F(Test8086, shl_dh_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xB448);
    cpu.set_bx(0x123D);
...
//
TEST_F(Test8086, shl_word_ds_bx_di_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xC212);
    cpu.set_bx(0x5326);
...
//
TEST_F(Test8086, shl_word_ds_bx_si_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x908D);
    cpu.set_bx(0xF7FB);
...
//
TEST_F(Test8086, shl_word_ds_si_3Ah_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xD649);
    cpu.set_bx(0x8E7C);
...
//
TEST_F(Test8086, shl_word_es_bx_7Ch_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xBF57);
    cpu.set_bx(0x63A3);
...
//
TEST_F(Test8086, shl_word_ss_bp_872h_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0x6AAF);
    cpu.set_bx(0x9B90);
...
// shr byte [ds:bx], cl
//
TEST_F(Test8086, shr_byte_ds_bx_cl_batch5)
{
    // Initial CPU State
    cpu.set_ax(0xDD6F);
    cpu.set_bx(0xDF62);
