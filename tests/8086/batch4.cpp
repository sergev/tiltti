...
//
TEST_F(Test8086, div_byte_cs_di_4636h_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x23CD);
    cpu.set_bx(0x42DF);
...
//
TEST_F(Test8086, div_byte_ds_bx_di_66h_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x779D);
    cpu.set_bx(0x4373);
...
//
TEST_F(Test8086, div_byte_ss_bp_di_7h_batch4)
{
    // Initial CPU State
    cpu.set_ax(0xC864);
    cpu.set_bx(0x494A);
...
// div word [ds:di]
//
TEST_F(Test8086, div_word_ds_di_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x16A9);
    cpu.set_bx(0x3027);
...
//
TEST_F(Test8086, div_word_ss_bp_di_5Bh_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x0000);
    cpu.set_bx(0x2927);
...
// idiv byte [ds:bx+di]
//
TEST_F(Test8086, idiv_byte_ds_bx_di_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x60E7);
    cpu.set_bx(0x8C38);
...
// idiv byte [ds:di]
//
TEST_F(Test8086, idiv_byte_ds_di_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x5C1D);
    cpu.set_bx(0xE567);
...
// idiv byte [ds:si+5Fh]
//
TEST_F(Test8086, idiv_byte_ds_si_5Fh_batch4)
{
    // Initial CPU State
    cpu.set_ax(0xED70);
    cpu.set_bx(0x5038);
...
//
TEST_F(Test8086, idiv_byte_ds_si_778h_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x3FBF);
    cpu.set_bx(0x24E0);
...
// idiv dh
//
TEST_F(Test8086, idiv_dh_batch4)
{
    // Initial CPU State
    cpu.set_ax(0xC635);
    cpu.set_bx(0x6D9E);
...
//
TEST_F(Test8086, idiv_word_cs_bp_3737h_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x8BF1);
    cpu.set_bx(0x8D9F);
...
// idiv word [ss:bp+di]
//
TEST_F(Test8086, idiv_word_ss_bp_di_batch4)
{
    // Initial CPU State
    cpu.set_ax(0xE221);
    cpu.set_bx(0x8521);
...
//
TEST_F(Test8086, idiv_word_ss_bp_si_16h_batch4)
{
    // Initial CPU State
    cpu.set_ax(0xBEF8);
    cpu.set_bx(0x3650);
...
//
TEST_F(Test8086, rcl_byte_ds_bp_di_1180h_cl_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x00C2);
    cpu.set_bx(0x7391);
...
// rcl di, cl
//
TEST_F(Test8086, rcl_di_cl_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x548C);
    cpu.set_bx(0xDD33);
...
//
TEST_F(Test8086, rcl_word_ds_bp_di_687Eh_cl_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x8B27);
    cpu.set_bx(0x35E6);
...
//
TEST_F(Test8086, sar_byte_ss_bp_si_7D9h_cl_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x25F7);
    cpu.set_bx(0xC9E5);
...
// sar word [ds:di], cl
//
TEST_F(Test8086, sar_word_ds_di_cl_batch4)
{
    // Initial CPU State
    cpu.set_ax(0x8DC3);
    cpu.set_bx(0xAEA6);
