...
//
TEST_F(Test8086, callf_word_ds_bx_si_2Fh_am88)
{
    // Initial CPU State
    cpu.set_ax(0x1300);
    cpu.set_bx(0x6B0E);
...
//
TEST_F(Test8086, lds_ax_dword_ds_bx_di_4Ah_am88)
{
    // Initial CPU State
    cpu.set_ax(0xD342);
    cpu.set_bx(0x1E93);
...
// mul word [es:bx+si]
//
TEST_F(Test8086, mul_word_es_bx_si_am88)
{
    // Initial CPU State
    cpu.set_ax(0x0107);
    cpu.set_bx(0xAE45);
