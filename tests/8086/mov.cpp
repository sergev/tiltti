...
TEST_F(Test8086, mov_al_byte_ds_8C42h)
{
    // Initial CPU State
    cpu.set_ax(0xF024);
    cpu.set_bx(0xEF9D);
...
TEST_F(Test8086, mov_ax_word_es_A2E9h)
{
    // Initial CPU State
    cpu.set_ax(0xA288);
    cpu.set_bx(0xCA78);
...
TEST_F(Test8086, mov_ax_word_ss_bp_si)
{
    // Initial CPU State
    cpu.set_ax(0xD269);
    cpu.set_bx(0x0CAA);
...
TEST_F(Test8086, mov_bl_byte_ds_bx_di_F4h)
{
    // Initial CPU State
    cpu.set_ax(0x3C09);
    cpu.set_bx(0x0000);
...
TEST_F(Test8086, mov_byte_ds_34A2h_6Ch)
{
    // Initial CPU State
    cpu.set_ax(0xE765);
    cpu.set_bx(0x3E74);
...
TEST_F(Test8086, mov_byte_ds_ABA1h_al)
{
    // Initial CPU State
    cpu.set_ax(0x7D00);
    cpu.set_bx(0x16A3);
...
TEST_F(Test8086, mov_es_word_ss_bp_di_7814h)
{
    // Initial CPU State
    cpu.set_ax(0x2DD6);
    cpu.set_bx(0xF390);
...
TEST_F(Test8086, mov_word_ds_bx_70ADh_sp)
{
    // Initial CPU State
    cpu.set_ax(0xECB6);
    cpu.set_bx(0xAD75);
...
TEST_F(Test8086, mov_word_es_AA78h_ax)
{
    // Initial CPU State
    cpu.set_ax(0x492C);
    cpu.set_bx(0x0B55);
...
TEST_F(Test8086, mov_word_ss_bp_F7h_671Dh)
{
    // Initial CPU State
    cpu.set_ax(0xC9E4);
    cpu.set_bx(0x85D4);
