...
TEST_F(Test8086, dec_byte_ss_bp_di_1Dh)
{
    // Initial CPU State
    cpu.set_ax(0xCBEC);
    cpu.set_bx(0x44F1);
...
TEST_F(Test8086, dec_word_es_si_3AE9h)
{
    // Initial CPU State
    cpu.set_ax(0x6AF1);
    cpu.set_bx(0x8A14);
...
TEST_F(Test8086, inc_byte_ss_bp_di)
{
    // Initial CPU State
    cpu.set_ax(0x76D3);
    cpu.set_bx(0xDD7A);
...
TEST_F(Test8086, inc_word_ss_bp_4Ch)
{
    // Initial CPU State
    cpu.set_ax(0x0E1F);
    cpu.set_bx(0xEE2D);
